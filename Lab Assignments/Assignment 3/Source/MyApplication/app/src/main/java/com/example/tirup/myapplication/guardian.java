...
public class guardian extends AppCompatActivity{
    ...
    private static final String GUARDIAN_API_URL= "https://content.guardianapis.com/search?api-key=8cde26ea-8975-46fc-ba5e-2816766d378d";
    ...
    public void searchGuardianAPI(View view) {
        if(searchText != null && StringUtils.isNotEmpty(searchText.getText().toString())){
            ...
            Toast.makeText(Guardian.this, "Input text should not be Empty !", Toast.LENGTH_LONG).show();
        }
    }
    ...
    private void fetchDetailsAndSet(String searchString) {
        ...
        try {
            ...
            ArrayAdapter listAdapter = new ArrayAdapter<String>(this, R.layout.activity_view, stringList);
            ...
            Log.e(Guardian.class.getSimpleName(), "Exception:  ", e);
        }
    }
}
